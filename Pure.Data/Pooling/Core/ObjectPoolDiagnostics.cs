...
namespace Pure.Data.Pooling
{
    public class ObjectPoolDiagnostics
    {
        ...
        /// </summary>
        public ObjectPoolDiagnostics(bool enable = true)
        {
        ...
        {
            return $"Enabled: {this.Enabled} , TotalLiveInstancesCount: {this.TotalLiveInstancesCount} , " +
                $"PoolObjectHitCount: {this.PoolObjectHitCount} , " +
                $"PoolObjectMissCount: {this.PoolObjectMissCount} , " +
                $"ObjectResetFailedCount: {this.ObjectResetFailedCount} , " +
                $"ReturnedToPoolByResurrectionCount: {this.ReturnedToPoolByResurrectionCount} , " +
                $"TotalInstancesCreated: {this.TotalInstancesCreated} , " +
                $"TotalInstancesDestroyed: {this.TotalInstancesDestroyed} , " +
                $"PoolOverflowCount: {this.PoolOverflowCount} , " +
                $"ReturnedToPoolCount: {this.ReturnedToPoolCount}" ;
        }
    }
}
