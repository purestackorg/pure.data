...
namespace Pure.Data
{
    ...
    public class PooledDatabase : PooledObject, IDatabase
    {
        ...
        public DatabasePool Pool { get; private set; }
        ...
        public PooledDatabase(string connKey, Action<IDatabaseConfig> InitConfig = null)
        {
        ...
        public PooledDatabase(string configFile, OutputActionDelegate _LogAction = null, Action<IDatabaseConfig> InitConfig = null)
        {
        ...
        public PooledDatabase(string connKey, string providerName, Action<IDatabaseConfig> InitConfig = null)
        {
            InitDatabaseConfig(InitConfig);
            var info = DbConnectionFactory.CreateConnectionByConfig(connKey, providerName);
            InitDbConnectionInfo(info);
        }
        public PooledDatabase(string connectionString, DatabaseType dbType, Action<IDatabaseConfig> InitConfig = null)
        {
            InitDatabaseConfig(InitConfig);
        ...
        public PooledDatabase(IDbConnection connection, Action<IDatabaseConfig> InitConfig = null)
        {
            InitDatabaseConfig(InitConfig);
