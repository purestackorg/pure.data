...
{   
    ...
    public interface ITransformationProvider : IDisposable
    {
        ...
        MigratorDbType MigratorDbType { get; }
        ...
        void AddTableDescription(string table, string description);
        void AddColumnDescription(string table, string column, string description);
        void RemoveTableDescription(string table);
        void RemoveColumnDescription(string table, string column );

        void AddSequence(SequenceDefinition seq);
        void RemoveSequence(string seqName);
        bool SequenceExists(string seqName);

        void AddTrigger(TriggerDefinition trg);
        void RemoveTrigger(string trgName);
        bool TriggerExists(string trgName);
