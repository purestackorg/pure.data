...
namespace Pure.Data.Migration.Providers
{
    ...
    public class NoOpTransformationProvider : ITransformationProvider
    {
        ...
        public void AddTableDescription(string table, string description)
        {
             
        }

        public void AddColumnDescription(string table, string column, string description)
        {
            
        }

        public void RemoveTableDescription(string table)
        {
             
        }

        public void RemoveColumnDescription(string table, string column)
        {
        ...
        public bool SequenceExists(string seqName)
        {
            return false;
        ...
        public void AddTrigger(TriggerDefinition trg)
        {
           
        }

        public void RemoveTrigger(string trgName)
        {
            
        }

        public bool TriggerExists(string trgName)
        {
            return false;
        }
    }
