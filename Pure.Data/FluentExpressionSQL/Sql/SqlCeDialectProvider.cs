...
{
    public class SqlCeDialectProvider : SqlDialectBaseProvider
    {
        private static SqlCeDialectProvider _instance = null;
        public static SqlCeDialectProvider Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new SqlCeDialectProvider();
