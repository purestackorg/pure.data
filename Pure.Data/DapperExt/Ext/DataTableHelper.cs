...
namespace Pure.Data
{
    ...
    public static class DataTableHelper
    {
        ...
        /// <returns></returns>
        public static Hashtable DataTableToHashtableByKeyValue(this DataTable dt, string keyField, string valFiled)
        {
        ...
        public static IList DataTableToIList<T>(this DataTable dt)
        {
            // 定义集合    
