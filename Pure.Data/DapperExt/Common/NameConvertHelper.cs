...
namespace Pure.Data
{
    ...
    public static class NameConvertHelper
    {
    ...
    public static class Inflector
    {
        ...
        /// <returns></returns>
        public static string ToPascalString(string value)
        {
            if (value == null || value == "") return string.Empty;
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static string ToCamelString(string value)
        {
            if (value == null || value == "") return string.Empty;

            string word = ToPascalString(value);
