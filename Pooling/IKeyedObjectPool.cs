...
namespace Pure.Data.Pooling
{
  ...
  */
    ...
    public interface IKeyedObjectPool<TKey, TValue>
    {
        /**
     ...
     */
         ...
         */
        void ReturnObject(TKey key, TValue obj);
         ...
         */
        void InvalidateObject(TKey key, TValue obj);
